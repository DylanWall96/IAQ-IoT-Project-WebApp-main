...
$BME = $db->getKitchenData ()->fetch_assoc ();
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown"><a href="#"
						...
						<div class="dropdown-menu">
							<a href="index.php" class="dropdown-item">Bedroom</a> <a
								href="kitchen.php" class="dropdown-item active">Kitchen</a>
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card shadow mb-12">
							...
							<div class="col-sm-4">
								...
								<h6 class="m-0 font-weight-bold text-danger" style="text-align: center;">Location -</h6>
								</div>
							
							
								<div class="col-sm-4">
									<h6 class="m-0 font-weight-bold text-danger" style="text-align: center;">Indoor Air Quality
										(IAQ) Score -</h6>
										</div>
										
										<div class="col-sm-4">
									<h6 class="m-0 font-weight-bold text-danger" style="text-align: center;">Overall Air Quality -</h6>
					...
					<div class="col-xl-12 ">
						<div class="card shadow mb-4">
							...
							<div
								class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-warning">Gas Resistance
									Time Series</h6>
...
function scoreGraph()
{
$.post("api/kitchen/scoreData.php",
function (data)
{
